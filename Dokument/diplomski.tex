...
Funkcija & Usp  & Neusp & Poslano (TPS) & Maks. latencija (s) & Min. latencija (s) & Pros. latencija (s) & Propusnost (TPS) \\ \hline
Transfer & 1306 & 0     & 43.6          & 3.99                & 0.03               & 1.02                & 39.3             \\ \hline
\end{tabular}%
}
\end{table}
...
\begin{table}[htb]
\centering
\caption{Utrošeni resursi}
\label{tbl:resources}
\resizebox{\textwidth}{!}{%
\begin{tabular}{|c|c|c|c|c|c|c|c|c|}
\hline
\rowcolor[HTML]{EFEFEF} 
Čvor                     & CPU\% (max) & CPU\% (pros.) & Memorija (max) {[}MB{]} & Memorija (pros.) {[}MB{]} & Ulazni promet {[}MB{]} & Izlazni promet {[}MB{]} & Pisanje diska {[}KB{]} & Čitanje diska {[}KB{]} \\ \hline
peer0.fer.unizg.hr-erc20 & 53.37       & 26.19         & 73.0                    & 72.3                      & 2.83                   & 2.02                    & 0.00                   & 0.00                   \\ \hline
peer0.fsb.unizg.hr-erc20 & 0.02        & 0.00          & 67.6                    & 67.6                      & 0.00599                & 0.00377                 & 0.00                   & 0.00                   \\ \hline
peer0.fer.unizg.hr       & 67.69       & 42.17         & 116                     & 116                       & 4.66                   & 5.91                    & 28.0                   & 24.0                   \\ \hline
peer0.fsb.unizg.hr       & 15.07       & 10.08         & 106                     & 106                       & 0.0597                 & 0.0491                  & 28.0                   & 0.00                   \\ \hline
orderer.unizg.hr         & 2.53        & 0.55          & 79.1                    & 79.1                      & 0.0153                 & 0.0263                  & 36.0                   & 0.00                   \\ \hline
couchdb0                 & 39.60       & 24.86         & 44.0                    & 42.5                      & 0.450                  & 0.492                   & 52.0                   & 96.0                   \\ \hline
couchdb1                 & 11.07       & 4.20          & 37.0                    & 37.0                      & 0.00204                & 0.00226                 & 52.0                   & 0.00                   \\ \hline
ca\_orderer              & 0.00        & 0.00          & 9.35                    & 9.35                      & 0.00                   & 0.00                    & 0.00                   & 0.00                   \\ \hline
ca\_fer                  & 0.28        & 0.04          & 3.50                    & 3.50                      & 0.00                   & 0.00                    & 0.00                   & 0.00                   \\ \hline
ca\_fsb                  & 0.00        & 0.00          & 3.36                    & 3.36                      & 0.00                   & 0.00                    & 0.00                   & 0.00                   \\ \hline
\end{tabular}%
}
\end{table}
...
\kljucnerijeci{blockchain, pametni ugovor, token, analiza, transakcija, baza podataka, glavna knjiga}
\end{sazetak}
...
Blockchain is one of technologies that has a huge impact on the 4th industrial revolution. Simply put,  blockchain is a transaction data log between parties in a network.  Blockchain can be permissioned or permissionless. In this paper, we analyze permissioned blockchains like Hyperledger Fabric, Quorum and Corda. Implementation of solution is done using Hyperledger Fabric on example of sharing menza points that represent fungible tokens and rectors' awards that represent non-fungible tokens. Tokens are implemented in form of smart contract and they are hypothetically traded between FER and FSB. Analysis was done using Hyperledger Caliper framework on the example of transfering fungible tokens between the two parties.
